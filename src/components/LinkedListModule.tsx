      ...
      <div className="flex flex-col lg:flex-row gap-8">
        <div className="flex-1 story-card p-6 md:p-8 flex flex-col relative overflow-hidden min-h-[500px]">
          <div className="flex flex-col md:flex-row justify-between items-start gap-6 mb-8 z-20">
            <div className="max-w-md">
              <h2 className="text-3xl md:text-4xl font-serif font-bold text-earth-parchment">The Caravan of Camels</h2>
            ...
            <AnimatePresence mode="popLayout">
              {list.map((camel, index) => (
                ...
                >
                  ...
                  >
                    <div className="w-24 h-24 bg-white/5 rounded-2xl flex flex-col items-center justify-center border-2 border-white/10 relative group">
                      <div className="absolute -top-3 bg-earth-clay text-earth-wood text-[10px] px-2 py-0.5 rounded-full font-bold uppercase">
                        {index === 0 ? 'Head' : index === list.length - 1 ? 'Tail' : `Node ${index}`}
                      </div>
                      
                      {/* Camel Icon Placeholder */}
                      <div className="w-12 h-12 text-earth-parchment mb-1">
                      ...
                      <span className="text-earth-parchment font-bold text-sm truncate w-20 text-center">{camel.value}</span>
                    </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-1 gap-6 lg:w-80 shrink-0">
          <div className="story-card p-6">
            <h3 className="text-lg font-serif font-bold text-earth-parchment mb-4">Caravan Master</h3>
