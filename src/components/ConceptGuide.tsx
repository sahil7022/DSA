  ...
  return (
    <div className="mt-4">
      <button
        ...
        className="w-full flex items-center justify-between p-4 bg-earth-clay/10 hover:bg-earth-clay/20 rounded-2xl transition-all duration-200 border border-earth-clay/20 group"
      >
        <div className="flex items-center gap-3 text-earth-wood font-bold text-sm">
      ...
      <AnimatePresence>
        {isOpen && (
          ...
          >
            <div className="p-6 bg-white/50 backdrop-blur-sm rounded-2xl mt-2 border border-earth-clay/10 space-y-4 shadow-inner">
              <p className="text-earth-wood font-medium italic text-sm leading-relaxed">
                "{guide.summary}"
              </p>
              ...
              <div className="space-y-2">
                ...
                <ul className="space-y-2">
                  {guide.steps.map((step, i) => (
                    <li key={i} className="flex gap-3 text-xs text-earth-wood/80 leading-relaxed">
              ...
              <div className="pt-4 border-t border-earth-clay/10">
                ...
                <p className="text-xs text-earth-wood/60 italic">
                  {guide.warning}
                </p>
              </div>
            </div>
