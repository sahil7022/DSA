...
const ScribesChallenge: React.FC<ScribesChallengeProps> = ({ concept }) => {
  ...
  return (
    <div className="story-card p-6 bg-gradient-to-br from-earth-terracotta/10 to-earth-sage/10 border-earth-terracotta/20">
      <div className="flex items-center gap-3 mb-6">
        <div className="bg-earth-terracotta p-2 rounded-xl text-white">
          <Trophy size={20} />
        </div>
        <h3 className="text-xl font-serif font-bold text-earth-parchment">The Scribe's Challenge</h3>
      </div>

      <p className="text-earth-parchment font-medium mb-6 leading-relaxed">
        {challenge.question}
      </p>
          ...
          <button
            ...
            className={`w-full text-left p-4 rounded-2xl border-2 transition-all duration-200 flex items-center justify-between group ${
              selected === i
                ...
                : 'border-white/10 hover:border-earth-terracotta/40 text-earth-parchment/70'
            }`}
          >
